...
<table style="border:none;" width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <p style="float:left; width:100%; margin:10px 0 10px 10px; color:#000; font-size:18px;">{{$SenderName}} invited you to the data room</p>
...
<p style="font-size:15px; padding:0px; line-height:24px; color:#000;" >{{$SenderName}}(<a href="#">{{$SenderEmail}}</a>)invited you to Project_name
data room</p>
