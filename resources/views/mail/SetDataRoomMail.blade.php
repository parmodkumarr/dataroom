...
<table style="border:none;" width="100%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    ...
    <p style="float:left; width:100%; margin:10px 0 10px 10px; color:#000; font-size:18px;">Prodata Team invited you to the data room</p>
...
<p style="font-size:15px; padding:0px; line-height:24px; color:#000;">Thank you for choosing prodata Solutions as your virtual data room provider for this project.

We are pleased to inform you that "{{$project}}" data room has been created and administrator’s access granted to you.

We look forward to working with you on this project.</p>

<a style="float:left; padding:10px 15px; margin:20px 0 0 0; background:#b56b7a; border:0px; color:#fff; text-decoration:none;" href="{{ $verifyUrl }}">Go To Dataroom</a>
